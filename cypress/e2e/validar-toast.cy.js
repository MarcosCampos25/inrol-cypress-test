describe('Verificar que los mensajes de error se muestran correctamente', () => {
  ...
  it('Agregar prdocuto con un color inválido (caso si la persona entra por url inválida o manipula el html)', () => {
    // Verifico la validación del lado del servidor en este caso
    cy.visit('pago/agregar_todo_al_carrito/1?cantidad=2&color=%23ff1111') // Acá pongo un color que no existe en ese producto
    cy.get('#enlace__agregar').click()
